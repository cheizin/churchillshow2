...
<!-- Mirrored from trapflix.com/staging/register by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2022 07:49:50 GMT -->
...
<head>
        ...
        <!-- Page Titles  -->
        <title>Sign Up | Churchill - Stream Hood Movies Online </title> 
...
<html lang="en">
	...
	<!-- sign in -->
	<div class="sign section--full-bg" data-bg="img/bg.html">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="sign__content sign_up">

						<!-- registration form -->
                        <form id="add-job-seeker-form2" class="mt-4" enctype="multipart/form-data">
					
                            <!--
                            <div class="sign__group" id="frmCheckUsername">
								<input type="text" class="sign__input" placeholder="Username" id="username" onBlur="checkAvailability()" name="username" required>
                                <span id="user-availability-status"></span>  
                                <p><img src="assets/media/gifs/loadericon.gif" id="loaderIcon" style="display:none" /></p>
							</div>
                         ...
                         <input type="hidden" value="standard" name="standard">
                             ...
                             <div class="sign__group">
								<input type="text" class="sign__input" placeholder="Full Name" name="fullName">
							</div>
                            <div class="sign__group">
								<input type="email" class="sign__input" placeholder="Email Address" name="Email">
							</div>
                            <div class="sign__group">
								<input type="tel" class="sign__input" placeholder="Phone Number" name="contact">
							</div>

							<div class="sign__group">
								<input type="password" id="password" class="sign__input" placeholder="Password" name="password" required>
                            ...
                            <div class="sign__group"><i class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="right"
                            title="Your Password associated to your Windows account" id="password_help"></i>
								<input type="password" id="confirm" class="sign__input" placeholder="Confirm Password" name="confirm_password" required>
							</div>

							<div class="sign__group sign__group--checkbox">
								<input id="remember" name="remember" type="checkbox" checked="checked" required>
								<label for="remember">I have read and agreed to the <a href="legal/terms-of-service.html">Terms of Service</a> and <a href="legal/privacy-policy.html">Privacy Policy</a></label>
							</div>
...
<!-- Mirrored from trapflix.com/staging/register by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2022 07:49:51 GMT -->
</html><!-- Scroll-To-Top @start -->
...
$(document).on("submit", "#add-job-seeker-form2", function(e){
  ...
  //process_url: "controllers/password-validation/password_verify.php",
      window.location.href = "https://churchill.potentialsoftwares.com/login.php";
