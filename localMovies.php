...
<!-- Mirrored from trapflix.com/staging/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2022 07:48:24 GMT -->
...
<head>
        ...
        <link rel="stylesheet" type="text/css" href="https://trapflix.com/assets/styles/main.css">
                ...
                <div class="header__content">
					...
					*/
					?>
                        ...
                        <a href="register.php" class="header__register">
                            <span>Register</span>
                        </a>
						<?php
						}
...
<section class="section">
	...
	<?php
      ...
      while($row = mysqli_fetch_array($sql))
	  {
		  ...
		  $video_views = mysqli_num_rows(mysqli_query($dbc,"SELECT video_id FROM video_views WHERE video_id='".$video_name['id']."'"));
      		?>


			<div class="feat__movies">
			<?php
				...
				<a onclick="Selectbanner('<?php echo $video_name['token'];?>');" class="feat__movies-cover">
				<img src="images/favoriteCompressed/<?php echo $video_name['thumbnail'];?>" alt="Churchill Banner">
				</a>
				<a onclick="Selectbanner('<?php echo $video_name['token'];?>');" class="play__btn">
                ...
                <span class="movie__views"><?php echo $video_views;?> views</span>
				<span class="duration">
				...
				<h3 class="feat__movies-title"><a href="movie/bannerDetails.php"><?php echo $video_name['textname'] ;?></a></h3>
				<?php
                   }
                  else
                   {
                 ?>
				 	<a onclick="Selectbanner2('<?php echo $video_name['token'];?>');" class="feat__movies-cover">
				<img src="images/favoriteCompressed/<?php echo $video_name['thumbnail'];?>" alt="Churchill Banner">
				</a>
				<a onclick="Selectbanner2('<?php echo $video_name['token'];?>');" class="play__btn">
													<!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In  -->
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="213.7px" height="213.7px" viewBox="0 0 213.7 213.7" enable-background="new 0 0 213.7 213.7" xml:space="preserve">
						<polygon class="triangle" id="XMLID_17_" fill="none" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="73.5,62.5 148.5,105.8 73.5,149.1 "></polygon>
						<circle class="circle" id="XMLID_18_" fill="none" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" cx="106.8" cy="106.8" r="103.3"></circle>
           ...
           while($row2 = mysqli_fetch_array($sql2))
			{
             ...
             $number = 1;
           		...
           		?>
				<div class="col-12">
					<h2 class="section__title"><a href="popular.html"><?php echo $row2['category_name']; ?></a></h2>
				</div>
                                  ...
                                  $no = 1;
                                   ...
                                   while($row3 = mysqli_fetch_array($sql3))
								   {
									  ...
									  <a onclick="Selectvideos2('<?php echo $video_name['token'];?>');">
											<img src="images/favoriteCompressed/<?php echo $video_name['thumbnail']; ?>" alt="Churchill">                                                                  
																							<span class="movie__views"><?php echo $video_views;?> views</span>
										 ...
										 <?php
                                          ...
                                          ?>
											...
											<span class="card__rating"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
												<path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.81.68,1,1,0,0,0,.25,1l4.13,4-1,5.68A1,1,0,0,0,6.9,21.44L12,18.77l5.1,2.67a.93.93,0,0,0,.46.12,1,1,0,0,0,.59-.19,1,1,0,0,0,.4-1l-1-5.68,4.13-4A1,1,0,0,0,22,9.67Zm-6.15,4a1,1,0,0,0-.29.88l.72,4.2-3.76-2a1.06,1.06,0,0,0-.94,0l-3.76,2,.72-4.2a1,1,0,0,0-.29-.88l-3-3,4.21-.61a1,1,0,0,0,.76-.55L12,5.7l1.88,3.82a1,1,0,0,0,.76.55l4.21.61Z"/></svg> 40 </span>
											<h3 class="card__title"> 
												<a href="movie/details55bc.html?mc=8362990">  
												<?php echo $video_name['textname']; ?> 
												</a>
											</h3>
											<ul class="card__list"> 
												<li>  <?php echo $video_name['title']; ?> </li>
												<li><span class="duration"><i class="far fa-clock"></i>21:32</span></li>
												<li><span><i class="far fa-calendar-alt"></i>2022</span></li> 
											</ul>
										</div>
   ...
   ?>
	<section class="section movies_section">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="section__title"><a href="latest.html"><?php echo $channel_name['category_name']; ?></a></h2>
				</div>
				...
				<div class="col-12">
                  ...
                  {?>
                           ...
                           while($row3 = mysqli_fetch_array($sql3))
						{
							...
							$video_views = mysqli_num_rows(mysqli_query($dbc,"SELECT video_id FROM video_views WHERE video_id='".$row3['id']."'"));
                           ?> 
							<div class="card">
							<?php
      $youtube_name = mysqli_query($dbc,"SELECT * FROM videos WHERE id ='".$row3['id']."' && youtube_vid ='youtube' ORDER BY order_id ASC") or die(mysqli_error($dbc));
                               ...
                               ?>    
									  <a onclick="Selectvideos2('<?php echo $row3['token'];?>');">
											<img src="images/favoriteCompressed/<?php echo $row3['thumbnail']; ?>" alt="Churchill">                                                                  
																							<span class="movie__views"><?php echo $video_views;?> views</span>
												<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M14.0501 11.4669C13.3211 12.2529 11.3371 13.5829 10.3221 14.0099C10.1601 14.0779 9.74711 14.2219 9.65811 14.2239C9.46911 14.2299 9.28711 14.1239 9.19911 13.9539C9.16511 13.8879 9.06511 13.4569 9.03311 13.2649C8.93811 12.6809 8.88911 11.7739 8.89011 10.8619C8.88911 9.90489 8.94211 8.95489 9.04811 8.37689C9.07611 8.22089 9.15811 7.86189 9.18211 7.80389C9.22711 7.69589 9.30911 7.61089 9.40811 7.55789C9.48411 7.51689 9.57111 7.49489 9.65811 7.49789C9.74711 7.49989 10.1091 7.62689 10.2331 7.67589C11.2111 8.05589 13.2801 9.43389 14.0401 10.2439C14.1081 10.3169 14.2951 10.5129 14.3261 10.5529C14.3971 10.6429 14.4321 10.7519 14.4321 10.8619C14.4321 10.9639 14.4011 11.0679 14.3371 11.1549C14.3041 11.1999 14.1131 11.3999 14.0501 11.4669Z" stroke-linecap="round" stroke-linejoin="round"/></svg>
											</a>
									<?php
							...
							<?php
								...
								<h3 class="card__title"> 
                                    <a href="movie/details4f84.html?mc=11916241"> 
									<?php echo $row3['textname']; ?>
                                    </a>
                                </h3>
								<ul class="card__list"> 
									<li> <?php echo $row3['title']; ?> </li>
                                    <li><span class="duration"><i class="far fa-clock"></i></span></li>
						            <li><span><i class="far fa-calendar-alt"></i></span></li> 
								</ul>
							</div>
							<?php
           				}
 ...
 ?>
	...
	<section class="section movies_section">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="section__title"><a href="top-rated.html">Top Rated</a></h2>
				</div>
					...
					<div class="section__carousel-wrap">
						<div class="section__carousel owl-carousel" id="binge">
                            ...
                            <div class="card">
                                ...
                                <a href="movie/details3fc0.html?mc=2677387"> 
                                                                                                        <img src="assets/media/posters/the-independent-game/the-independent-game-image.jpg" alt="The Independent Game poster image.">                                                                  
                                                                        <span class="movie__views">11 views</span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M14.0501 11.4669C13.3211 12.2529 11.3371 13.5829 10.3221 14.0099C10.1601 14.0779 9.74711 14.2219 9.65811 14.2239C9.46911 14.2299 9.28711 14.1239 9.19911 13.9539C9.16511 13.8879 9.06511 13.4569 9.03311 13.2649C8.93811 12.6809 8.88911 11.7739 8.89011 10.8619C8.88911 9.90489 8.94211 8.95489 9.04811 8.37689C9.07611 8.22089 9.15811 7.86189 9.18211 7.80389C9.22711 7.69589 9.30911 7.61089 9.40811 7.55789C9.48411 7.51689 9.57111 7.49489 9.65811 7.49789C9.74711 7.49989 10.1091 7.62689 10.2331 7.67589C11.2111 8.05589 13.2801 9.43389 14.0401 10.2439C14.1081 10.3169 14.2951 10.5129 14.3261 10.5529C14.3971 10.6429 14.4321 10.7519 14.4321 10.8619C14.4321 10.9639 14.4011 11.0679 14.3371 11.1549C14.3041 11.1999 14.1131 11.3999 14.0501 11.4669Z" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                </a>
                                <span class="card__rating"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.81.68,1,1,0,0,0,.25,1l4.13,4-1,5.68A1,1,0,0,0,6.9,21.44L12,18.77l5.1,2.67a.93.93,0,0,0,.46.12,1,1,0,0,0,.59-.19,1,1,0,0,0,.4-1l-1-5.68,4.13-4A1,1,0,0,0,22,9.67Zm-6.15,4a1,1,0,0,0-.29.88l.72,4.2-3.76-2a1.06,1.06,0,0,0-.94,0l-3.76,2,.72-4.2a1,1,0,0,0-.29-.88l-3-3,4.21-.61a1,1,0,0,0,.76-.55L12,5.7l1.88,3.82a1,1,0,0,0,.76.55l4.21.61Z"/></svg> 50 </span>
                               	<h3 class="card__title"> 
                                    <a href="movie/details3fc0.html?mc=2677387"> 
                                ...
                                <ul class="card__list"> 
                                    <li>  <?php echo $row3['title']; ?></li>
                                    <li><span class="duration"><i class="far fa-clock"></i>58:56</span></li>
						            <li><span><i class="far fa-calendar-alt"></i>2022</span></li> 
                                </ul>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <a href="movie/details55bc.html?mc=8362990"> 
                                                                        ...
                                                                        <span class="movie__views">78 views</span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M14.0501 11.4669C13.3211 12.2529 11.3371 13.5829 10.3221 14.0099C10.1601 14.0779 9.74711 14.2219 9.65811 14.2239C9.46911 14.2299 9.28711 14.1239 9.19911 13.9539C9.16511 13.8879 9.06511 13.4569 9.03311 13.2649C8.93811 12.6809 8.88911 11.7739 8.89011 10.8619C8.88911 9.90489 8.94211 8.95489 9.04811 8.37689C9.07611 8.22089 9.15811 7.86189 9.18211 7.80389C9.22711 7.69589 9.30911 7.61089 9.40811 7.55789C9.48411 7.51689 9.57111 7.49489 9.65811 7.49789C9.74711 7.49989 10.1091 7.62689 10.2331 7.67589C11.2111 8.05589 13.2801 9.43389 14.0401 10.2439C14.1081 10.3169 14.2951 10.5129 14.3261 10.5529C14.3971 10.6429 14.4321 10.7519 14.4321 10.8619C14.4321 10.9639 14.4011 11.0679 14.3371 11.1549C14.3041 11.1999 14.1131 11.3999 14.0501 11.4669Z" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                </a>
                                <span class="card__rating"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.81.68,1,1,0,0,0,.25,1l4.13,4-1,5.68A1,1,0,0,0,6.9,21.44L12,18.77l5.1,2.67a.93.93,0,0,0,.46.12,1,1,0,0,0,.59-.19,1,1,0,0,0,.4-1l-1-5.68,4.13-4A1,1,0,0,0,22,9.67Zm-6.15,4a1,1,0,0,0-.29.88l.72,4.2-3.76-2a1.06,1.06,0,0,0-.94,0l-3.76,2,.72-4.2a1,1,0,0,0-.29-.88l-3-3,4.21-.61a1,1,0,0,0,.76-.55L12,5.7l1.88,3.82a1,1,0,0,0,.76.55l4.21.61Z"/></svg> 40 </span>
                               	<h3 class="card__title"> 
                                    <a href="movie/details55bc.html?mc=8362990"> 
                                        Summertime in the Bluff 
                                    </a>
                                </h3>
                                <ul class="card__list"> 
                                    <li> Villasmill </li>
                            ...
                            <div class="card">
                                ...
                                <a href="movie/details92fc.html?mc=5898220"> 
                                                                                                        <img src="assets/media/posters/independent-game-ii/independent-game-ii-image.jpg" alt="Independent Game II poster image.">                                                                  
                                                                        <span class="movie__views">8 views</span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M14.0501 11.4669C13.3211 12.2529 11.3371 13.5829 10.3221 14.0099C10.1601 14.0779 9.74711 14.2219 9.65811 14.2239C9.46911 14.2299 9.28711 14.1239 9.19911 13.9539C9.16511 13.8879 9.06511 13.4569 9.03311 13.2649C8.93811 12.6809 8.88911 11.7739 8.89011 10.8619C8.88911 9.90489 8.94211 8.95489 9.04811 8.37689C9.07611 8.22089 9.15811 7.86189 9.18211 7.80389C9.22711 7.69589 9.30911 7.61089 9.40811 7.55789C9.48411 7.51689 9.57111 7.49489 9.65811 7.49789C9.74711 7.49989 10.1091 7.62689 10.2331 7.67589C11.2111 8.05589 13.2801 9.43389 14.0401 10.2439C14.1081 10.3169 14.2951 10.5129 14.3261 10.5529C14.3971 10.6429 14.4321 10.7519 14.4321 10.8619C14.4321 10.9639 14.4011 11.0679 14.3371 11.1549C14.3041 11.1999 14.1131 11.3999 14.0501 11.4669Z" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                </a>
                                <span class="card__rating"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.81.68,1,1,0,0,0,.25,1l4.13,4-1,5.68A1,1,0,0,0,6.9,21.44L12,18.77l5.1,2.67a.93.93,0,0,0,.46.12,1,1,0,0,0,.59-.19,1,1,0,0,0,.4-1l-1-5.68,4.13-4A1,1,0,0,0,22,9.67Zm-6.15,4a1,1,0,0,0-.29.88l.72,4.2-3.76-2a1.06,1.06,0,0,0-.94,0l-3.76,2,.72-4.2a1,1,0,0,0-.29-.88l-3-3,4.21-.61a1,1,0,0,0,.76-.55L12,5.7l1.88,3.82a1,1,0,0,0,.76.55l4.21.61Z"/></svg> 30 </span>
                               	<h3 class="card__title"> 
                                    <a href="movie/details92fc.html?mc=5898220"> 
                                        Independent Game II 
                                    </a>
                            ...
                            <div class="card">
                                ...
                                <a href="movie/details0f9f.html?mc=7920558"> 
                                                                                                        <img src="assets/media/posters/chiraq-god039s-plan/chiraq-god039s-plan-image.jpg" alt="Chiraq God&#039;s Plan poster image.">                                                                  
                                                                        <span class="movie__views">20 views</span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M14.0501 11.4669C13.3211 12.2529 11.3371 13.5829 10.3221 14.0099C10.1601 14.0779 9.74711 14.2219 9.65811 14.2239C9.46911 14.2299 9.28711 14.1239 9.19911 13.9539C9.16511 13.8879 9.06511 13.4569 9.03311 13.2649C8.93811 12.6809 8.88911 11.7739 8.89011 10.8619C8.88911 9.90489 8.94211 8.95489 9.04811 8.37689C9.07611 8.22089 9.15811 7.86189 9.18211 7.80389C9.22711 7.69589 9.30911 7.61089 9.40811 7.55789C9.48411 7.51689 9.57111 7.49489 9.65811 7.49789C9.74711 7.49989 10.1091 7.62689 10.2331 7.67589C11.2111 8.05589 13.2801 9.43389 14.0401 10.2439C14.1081 10.3169 14.2951 10.5129 14.3261 10.5529C14.3971 10.6429 14.4321 10.7519 14.4321 10.8619C14.4321 10.9639 14.4011 11.0679 14.3371 11.1549C14.3041 11.1999 14.1131 11.3999 14.0501 11.4669Z" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                </a>
                                <span class="card__rating"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.81.68,1,1,0,0,0,.25,1l4.13,4-1,5.68A1,1,0,0,0,6.9,21.44L12,18.77l5.1,2.67a.93.93,0,0,0,.46.12,1,1,0,0,0,.59-.19,1,1,0,0,0,.4-1l-1-5.68,4.13-4A1,1,0,0,0,22,9.67Zm-6.15,4a1,1,0,0,0-.29.88l.72,4.2-3.76-2a1.06,1.06,0,0,0-.94,0l-3.76,2,.72-4.2a1,1,0,0,0-.29-.88l-3-3,4.21-.61a1,1,0,0,0,.76-.55L12,5.7l1.88,3.82a1,1,0,0,0,.76.55l4.21.61Z"/></svg> 20 </span>
                               	<h3 class="card__title"> 
                                    <a href="movie/details0f9f.html?mc=7920558"> 
                                        Chiraq God&#039;s Plan 
                                    </a>
                            ...
                            <div class="card">
                                ...
                                <a href="movie/detailsca4a.html?mc=7306453"> 
                            ...
                            <div class="card">
                                ...
                                <a href="movie/details99d0.html?mc=4371820"> 
                            ...
                            <div class="card">
                                ...
                                <a href="movie/detailsec1b.html?mc=10474954"> 
                            ...
                            <div class="card">
                                ...
                                <a href="movie/details449d.html?mc=6338068"> 
                            ...
                            <div class="card">
                                ...
                                <a href="movie/details3a52.html?mc=12747807"> 
                            ...
                            <div class="card">
                                ...
                                <a href="movie/details30dc.html?mc=9481763"> 
                            ...
                            <div class="card">
                                ...
                                <a href="movie/detailse73f.html?mc=13356275"> 
...
<!-- Mirrored from trapflix.com/staging/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2022 07:49:19 GMT -->
</html>