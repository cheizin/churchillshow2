				...
				<div class="row" id="payments_section">
                    ...
                    <div class="article__content">
                        ...
                        <ul class="list">
                            ...
                            <li><?php echo $video_post['time_created']; ?></li>
                            <li> <p> <?php echo $video_post['video_description']; ?> </p> </li>
					...
					*/
					?>
                            ...
                            <div class="row">
                                ...
                                <a onclick="Selectvideos2('<?php echo $video_post['token'];?>');" class="login__btn-inner">
                                Play Movie
								</a>
...
location.href = "playMovies.php?token="+token;
}
    </script>
</body>
