            ...
            <div class="col-12">
                <div class="header__content">
                    ...
                    <li class="header__nav-item">
                            <a class="header__nav-link" href="https://churchill.potentialsoftwares.com/">Home</a>
                        </li>
                        <li class="header__nav-item">
...
-->
                    ...
                    <div class="col-12 col-lg-6">
                     ...
                     <!-- article content -->
                        ...
                        <h1> <?php echo $video_post['textname']; ?> </h1>
                       
                        <ul class="list">
                             <li><?php echo $video_post['title']; ?> </li>
                             <li>  <?php echo $video_views;?> views</li>
                             <li>        					<?php
                         $subsccribe_no = mysqli_num_rows(mysqli_query($dbc,"SELECT * FROM channel_subscription WHERE channel_name ='".$video_post['title']."'"));
                     ?>
                               <?php echo $subsccribe_no;?> Subscribers</li>
                               <li><time class="timeago" datetime="<?php echo $video_post['time_created'];?>"><?php echo $video_post['time_created'];?></time></li>
                             ...
                             if($total_rows1 = mysqli_num_rows($sql_query1) > 0)
                             {
                               ?>
                                       <form id="subscribe-form" class="mt-4">
                                    	...
                                    	<div class="hover-buttons subscription-status-button">
                                    		<button type="submit" class="login__btn-inner submitting" title="Click Here to Unsubscribe to this Channel"><i class="fa fa-play mr-1" aria-hidden="true"></i> Unsubscribe </button>
                                    	</div>
                                    </form>
                                    <?php
                              }
                              else
                              {
                                 ...
                                 <form id="subscribe-form" class="mt-4">
                                    ...
                                    <input type="hidden" name="token2" value="<?php echo $_GET['token'];?>">
                                    <div class="hover-buttons subscription-status-button">
                                        <button type="submit" class="login__btn-inner submitting" title="Click Here to Subscribe to this Channel"><i class="fa fa-play mr-1" aria-hidden="true"></i> Subscribe </button>
                                    </div>
                                    </form>
                                    <?php
                                }
...
?>
 ...
 <strong> </strong> Comments
										...
										<span><?php echo $comments_no;?></span>
									</a>
								</li>
					...
					<div class="col-12 col-xl-4">
						<div class="sidebar sidebar--mt">
							...
							<div class="row row--grid">
								<div class="col-12">
									<h5 class="sidebar__title">Similar Movies</h5>
								</div>
								...
								<div class="col-6 col-sm-4 col-md-3 col-xl-6">
									<div class="card">
										...
										<h3 class="card__title"><a href="#">Jugg City Episode 2</a></h3>
										<ul class="card__list">
											<li>Free</li>
											<li>Villasmill</li>
											<li>2022</li>
								...
								<div class="col-6 col-sm-4 col-md-3 col-xl-6">
									<div class="card">
										...
										<button class="card__add" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16,2H8A3,3,0,0,0,5,5V21a1,1,0,0,0,.5.87,1,1,0,0,0,1,0L12,18.69l5.5,3.18A1,1,0,0,0,18,22a1,1,0,0,0,.5-.13A1,1,0,0,0,19,21V5A3,3,0,0,0,16,2Zm1,17.27-4.5-2.6a1,1,0,0,0-1,0L7,19.27V5A1,1,0,0,1,8,4h8a1,1,0,0,1,1,1Z"/></svg></button>
										<span class="card__rating"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.81.68,1,1,0,0,0,.25,1l4.13,4-1,5.68A1,1,0,0,0,6.9,21.44L12,18.77l5.1,2.67a.93.93,0,0,0,.46.12,1,1,0,0,0,.59-.19,1,1,0,0,0,.4-1l-1-5.68,4.13-4A1,1,0,0,0,22,9.67Zm-6.15,4a1,1,0,0,0-.29.88l.72,4.2-3.76-2a1.06,1.06,0,0,0-.94,0l-3.76,2,.72-4.2a1,1,0,0,0-.29-.88l-3-3,4.21-.61a1,1,0,0,0,.76-.55L12,5.7l1.88,3.82a1,1,0,0,0,.76.55l4.21.61Z"/></svg> 0</span>
										<h3 class="card__title"><a href="#">Jugg City Episode 1</a></h3>
										<ul class="card__list">
											<li>Free</li>
											<li>Villasmill</li>
											<li>2022</li>
								...
								<div class="col-6 col-sm-4 col-md-3 col-xl-6">
									<div class="card">
										...
										<button class="card__add" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16,2H8A3,3,0,0,0,5,5V21a1,1,0,0,0,.5.87,1,1,0,0,0,1,0L12,18.69l5.5,3.18A1,1,0,0,0,18,22a1,1,0,0,0,.5-.13A1,1,0,0,0,19,21V5A3,3,0,0,0,16,2Zm1,17.27-4.5-2.6a1,1,0,0,0-1,0L7,19.27V5A1,1,0,0,1,8,4h8a1,1,0,0,1,1,1Z"/></svg></button>
										<span class="card__rating"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.81.68,1,1,0,0,0,.25,1l4.13,4-1,5.68A1,1,0,0,0,6.9,21.44L12,18.77l5.1,2.67a.93.93,0,0,0,.46.12,1,1,0,0,0,.59-.19,1,1,0,0,0,.4-1l-1-5.68,4.13-4A1,1,0,0,0,22,9.67Zm-6.15,4a1,1,0,0,0-.29.88l.72,4.2-3.76-2a1.06,1.06,0,0,0-.94,0l-3.76,2,.72-4.2a1,1,0,0,0-.29-.88l-3-3,4.21-.61a1,1,0,0,0,.76-.55L12,5.7l1.88,3.82a1,1,0,0,0,.76.55l4.21.61Z"/></svg> 0</span>
										<h3 class="card__title"><a href="#">Instastalker</a></h3>
										<ul class="card__list">
											<li>Free</li>
											<li>Villasmill</li>
											<li>2022</li>
								...
								<div class="col-6 col-sm-4 col-md-3 col-xl-6">
									<div class="card">
										...
										<button class="card__add" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M16,2H8A3,3,0,0,0,5,5V21a1,1,0,0,0,.5.87,1,1,0,0,0,1,0L12,18.69l5.5,3.18A1,1,0,0,0,18,22a1,1,0,0,0,.5-.13A1,1,0,0,0,19,21V5A3,3,0,0,0,16,2Zm1,17.27-4.5-2.6a1,1,0,0,0-1,0L7,19.27V5A1,1,0,0,1,8,4h8a1,1,0,0,1,1,1Z"/></svg></button>
										<span class="card__rating"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.81.68,1,1,0,0,0,.25,1l4.13,4-1,5.68A1,1,0,0,0,6.9,21.44L12,18.77l5.1,2.67a.93.93,0,0,0,.46.12,1,1,0,0,0,.59-.19,1,1,0,0,0,.4-1l-1-5.68,4.13-4A1,1,0,0,0,22,9.67Zm-6.15,4a1,1,0,0,0-.29.88l.72,4.2-3.76-2a1.06,1.06,0,0,0-.94,0l-3.76,2,.72-4.2a1,1,0,0,0-.29-.88l-3-3,4.21-.61a1,1,0,0,0,.76-.55L12,5.7l1.88,3.82a1,1,0,0,0,.76.55l4.21.61Z"/></svg> 0</span>
										<h3 class="card__title"><a href="#">Dirt On My Boots 5</a></h3>
										<ul class="card__list">
											<li>Free</li>
											<li>Villasmill</li>
											<li>2022</li>
