...
$consumer_key="IPpEghgz+K+Mc9jYcZxyIU7G/gN2nAgX";//Register a merchant account on
                   //demo.pesapal.com and use the merchant key for testing.
                   //When you are ready to go live make sure you change the key to the live account
                   //registered on www.pesapal.com!
$consumer_secret="umZavXdKIDYkztkJQyYmOHsW35I=";// Use the secret from your test
       ...
       if ($status == "PENDING")
       {
        ...
        //end sending verification sms
           ...
           <p style="color:orange;">Payment Status : <b>PENDING</b></p>
            <a href='https://churchill.potentialsoftwares.com/payments/PaymentsIPN.php?pesapal_transaction_tracking_id=<?php echo $pesapalTrackingId ;?>&pesapal_merchant_reference=<?php echo $pesapal_merchant_reference ;?>'>Update Payment</a>
           <?php
       }
