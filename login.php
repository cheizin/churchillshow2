...
<!-- Mirrored from trapflix.com/staging/login by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2022 07:49:49 GMT -->
                ...
                <div class="sign__content">
                    ...
                    <form id="test-login-form" class="mt-4" enctype="multipart/form-data">
                        ...
                        <div class="sign__group">
                            <input type="email" class="sign__input" autocomplete="on" id="email" name="email" placeholder="Enter email"  required>
                        </div>

                        <div class="sign__group">
                            <input type="password" class="sign__input" name="password" id="password" autocomplete="off" placeholder="Password" required>
                        </div>

                        <div class="sign__group sign__group--checkbox">
                            <input id="remember" name="remember_me" value="yes" type="checkbox">
...
<!-- Mirrored from trapflix.com/staging/login by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2022 07:49:50 GMT -->
</html>
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(data == "success")
            {
              ...
              window.location.href = "https://churchill.potentialsoftwares.com/";
